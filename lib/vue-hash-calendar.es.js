...
let formatDate = function(time, format, lang = "CN") {
  ...
  const models = { "../language/index.ts": __glob_0_0 };
  ...
  let newTime = format.replace(/YY/g, year).replace(/F/g, hour >= 12 ? "pm" : "am").replace(/ss/g, preArr[sec] || sec).replace(/mm/g, preArr[min] || min).replace(
    /hh/g,
    ...
    const isDisabledHorizontalScroll = (direc) => {
      ...
      if (isShowWeek.value) {
        let lastWeekLastedDay = new Date(
          `${lastWeek.value[6].year}/${lastWeek.value[6].month + 1}/${lastWeek.value[6].day}`
        ).getTime();
        let nextWeekFirstDay = new Date(
          `${nextWeek.value[0].year}/${nextWeek.value[0].month + 1}/${nextWeek.value[0].day}`
        ).getTime();
        ...
        let lastMonthLastedDay = new Date(
          `${lastMonthYear.value}/${lastMonth.value + 1}/${daysOfMonth(lastMonthYear.value)[lastMonth.value]}`
        ).getTime();
    ...
    watch(
      ...
      (val) => {
        if (val && props.disabledWeekView) {
          throw new Error(
            "'isShowWeekView'\xA0and\xA0'disabledWeekView'\xA0can't\xA0be\xA0used\xA0at\xA0the\xA0same\xA0time"
          );
        }
      },
      { immediate: true }
...
var Calendar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-33b56bb4"]]);
...
var ScrollContainer = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fc98788e"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const isDisabled = (date, index2) => {
      ...
      if (props.type === "month") {
        fDate = new Date(
          `${props.calendarDate.year}/${parseInt(index2) + 1}/${props.calendarDate.day}`
        );
      } else if (props.type === "year") {
        fDate = new Date(
          `${date}/${parseInt(props.calendarDate.month) + 1}/${props.calendarDate.day}`
        );
      } else if (props.type === "yearRange") {
        const yearArr = getRangeYear(date);
        return yearArr.every((year) => {
          fDate = new Date(
            `${year}/${parseInt(props.calendarDate.month) + 1}/${props.calendarDate.day}`
          );
          return props.disabledDate(fDate) || !isDateInRange(fDate, props.minDate, props.maxDate);
        });
      }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const dateClick = (date) => {
      ...
      checkedDate.value = date;
      let fDate = new Date(
        `${checkedDate.value.year}/${checkedDate.value.month + 1}/${checkedDate.value.day} ${checkedDate.value.hours}:${checkedDate.value.minutes}`
      );
      if (props.format) {
      ...
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          _ctx.isShowAction ? (openBlock(), createElementBlock("div", {
            ...
            renderSlot(_ctx.$slots, "action", {}, () => [
              createElementVNode("div", _hoisted_1, [
                ...
                }, toDisplayString(formatDatetime(
                  `${checkedDate.value.year}/${checkedDate.value.month + 1}/${checkedDate.value.day}`,
                ...
                _ctx.pickerType !== "date" ? (openBlock(), createElementBlock("span", {
                  ...
                  `${checkedDate.value.year}/${checkedDate.value.month + 1}/${checkedDate.value.day} ${fillNumber(checkedDate.value.hours)}:${fillNumber(
          ...
          _ctx.pickerType !== "time" ? (openBlock(), createBlock(Calendar, mergeProps({
            ...
            "is-show-week-view": unref(isShowWeek),
            "onUpdate:is-show-week-view": _cache[0] || (_cache[0] = ($event) => isRef(isShowWeek) ? isShowWeek.value = $event : null)
          ...
          ]), 1040, ["show", "is-show-week-view", "calendarTitleHeight", "default-date"])) : createCommentVNode("", true),
          ...
          }, { ..._ctx.$props, ..._ctx.$attrs }, { onChange: timeChange }), null, 16, ["show", "default-time", "calendarDate"])) : createCommentVNode("", true),
...
var DatetimePicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2562c233"]]);
